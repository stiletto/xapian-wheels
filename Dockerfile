...
RUN apt-get update && apt-get install --no-install-recommends --yes git build-essential curl wget ca-certificates gpg gpg-agent software-properties-common zlib1g-dev
